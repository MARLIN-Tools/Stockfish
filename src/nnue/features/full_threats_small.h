...
#ifndef NNUE_FEATURES_FULL_THREATS_SMALL_INCLUDED
#define NNUE_FEATURES_FULL_THREATS_SMALL_INCLUDED
...
static constexpr int numValidTargetsSmall[PIECE_NB] = {0, 6, 12, 10, 10, 12, 8, 0,
                                                       0, 6, 12, 10, 10, 12, 8, 0};

class FullThreatsSmall {
   public:
    // Feature name
...
#endif  // #ifndef NNUE_FEATURES_FULL_THREATS_SMALL_INCLUDED
